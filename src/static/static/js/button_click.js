...
$(document).ready(function(){
	...
	$('.progress-button').progressInitialize();
	 ...
	 $('#vars-data-promt').click(function(e){
	...
	$.fn.progressInitialize = function(){
		...
		return this.each(function(){
			...
			var options = $.extend({
				...
				loading: 'Creating and testing key..',
				finished: 'Done!'
			}, button.data());
...
// working with button disable and message
...
//               $( document ).ajaxStop(function() {
//               $("#jmessage").addClass("alert alert-success").text( "Key was successfully generated and tested!" );
//             });
//        });
